    ...
    <>
        ...
        <div className='container-pre-treino-zz'>
            ...
            <div className='container-texto-pre-treino'>
                ...
                <p>A ingestão pré-treino vai variar de acordo com algumas características individuais, como altura, peso corporal, gênero, objetivo e, também, das variáveis do treino — se ele é curto e intenso, longo e de baixa intensidade etc.</p>
        ...
        <div className='container-pre-treino-zz'>
            <div className='container-texto-pre-treino'>
                ...
                <p>Nesse contexto, alguns nutrientes poderão ser altamente benéficos, como:</p>
                <ul>
                    <li>Taurina</li>
                    <li>Cafeína</li>
                    <li>Inositol</li>
        ...
        <div className='container-pre-treino-zz'>
            ...
            <div className='container-texto-pre-treino'>
                ...
                <p>O equilíbrio entre proteínas, carboidratos, gorduras, sais minerais, vitaminas, fibras, compostos bioativos e água depende diretamente das necessidades de cada pessoa. Não existe uma fórmula pré-estabelecida. A nutrição deve compreender os indivíduos em todas as suas características, e é isso que gera o equilíbrio.</p>
                <p>Não há como pensar em equilíbrio orgânico falando de apenas 2 nutrientes sendo que são necessários aproximadamente 42 ao longo de todo o dia. De uma forma geral, podemos dizer que os carboidratos e proteínas são responsáveis por fornecer energia direta às células musculares. A partir disso, podemos ter recomendações como:</p>
                <ul>
                    <li>3 a 4 horas antes da sessão, 200 a 300g de carboidratos</li>
                    <li>1 a 2 horas antes, 1 a 2g/kg peso de carboidratos</li>
